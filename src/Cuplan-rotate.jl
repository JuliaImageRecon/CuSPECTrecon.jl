...
"""
    show(io::IO, ::MIME"text/plain", plan::CuPlanRotate)
"""
function Base.show(io::IO, ::MIME"text/plain", plan::CuPlanRotate{T, G2}) where {T, G2}
    t = typeof(plan)
    println(io, t)
...
"""
    sizeof(::CuPlanRotate)
Show size in bytes of `CuPlanRotate` object.
"""
function Base.sizeof(ob::T) where {T <: CuPlanRotate}
